...
// function getBaseURL() {
//   // Browser precisa de NEXT_PUBLIC_API_URL
//   if (typeof window !== "undefined") {
//     const publicApi = process.env.NEXT_PUBLIC_API_URL; // ex: http://localhost:8000
//     if (!publicApi) return "http://localhost:8000/api/v1"; // fallback
//     return `${publicApi}/api/v1`;
//   }

//   // Server pode usar API_URL (docker: http://backend:8000)
//   const serverApi = process.env.API_URL;
//   if (!serverApi) return "http://backenddev:8000/api/v1";
//   return `${serverApi}/api/v1`;
// }
